...
from amr_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "amr_base"
        self.static_transform_stamped_.child_frame_id = "amr_top"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_._child_frame_id = "amr_base"
    ...
    def getTransformCallback(self, req, res):
        ...
        try:
            ...
            self.get_logger().error("An error occured while transforming %s" % (req.frame_id, req.child_frame_id))
            res.success = False
            return res
